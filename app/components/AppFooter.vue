...
<template>
  <footer class="border-t border-(--dk-line)">
      ...
      <div class="flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div class="flex items-center gap-3">
          <a
            ...
            target="_blank"
            rel="noopener"
            class="p-2.5 rounded-[4px] text-(--dk-dim) hover:text-(--dk-ink) hover:bg-(--dk-panel-hover) transition-colors">
            <UIcon
              :name="social.icon"
              class="w-5 h-5"/>
          </a>
        ...
        <!-- Copyright & Legal -->
        <div class="text-xs text-(--dk-dim) text-center md:text-right leading-relaxed">
          <p>IČO: 17389178</p>
